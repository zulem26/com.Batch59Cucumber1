...
public class Hooks {
    /*
        ...
        Cucumber da @before, @after kullanma ihtiyacimiz olursa bunu stepdefinitions package i altinda
        olusturacagimiz hooks class ina koyariz

        biz her scenario dan sonra test sonucunu konrol edip failed olan scenario lar icin
